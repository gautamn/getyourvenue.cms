...
<div class="module">
  ...
  <div class="module-table-body">
    <form action="" method="post" id="searchLeads" name="searchLeads">
      <table border="0" class="NoBorder">
        <tr>
          <td class="wid35prcnt">
              ...
              <span class="FieldBox"><input class="submit-green" id="btn_search" onclick="searchLeads();" type="button" value="Search" /></span>
            </td>
        </tr>
      </table>
    </form>
        ...
        <table id="myTable" class="tablesorter">
            <thead>
                <tr>
                    ...
                    <th style="width:30%">Preferred Venue/ Region/ Date</th>
                    <th style="width:20%">Guest / Budget</th>
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo facile::$regionIdName[$rows['preferred_region']].'<br>';
                    echo $rows['preferred_venue'];
                    echo '<br>'.$rows['preferred_date'];?></td>
                    <td><?php echo !empty($rows['no_of_guests']) ? $rows['no_of_guests'] .' guests ' : ''; echo !empty($rows['budget']) ? $rows['budget'] : '';?></td>
