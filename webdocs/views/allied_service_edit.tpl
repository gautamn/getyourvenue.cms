        ...
        <form action="" id="alliedServiceForm" enctype="multipart/form-data" method="post">
          ...
          <div class="widthper fl">
            <div class="add-clip">
              ...
              <p><input name="service_name" maxlength="100" type="text" class="input-short" id="service_name" value="<?php echo $records['HEADING'];?>" /></p>
              <div class="cl"></div>
            </div>
            <div class="add-clip">
          ...
          <div class="widthper fr">
            <div class="add-clip">
              <label>SEO ID </label>
              <p><input name="seo_title" maxlength="100" readonly="" type="text" class="input-short" id="seo_title" value="<?php echo $records['SEO_ID'];?>" /></p>
              <div class="cl"></div>
            </div>
            <div class="add-clip">
              <label>Banner Path </label>
              <p><input name="banner_path" maxlength="100" type="text" class="input-short" id="banner_path" value="<?php echo $records['BANNER_PATH'];?>" /></p>
              <div class="cl"></div>
            </div>
            <div class="add-clip">
              <label>Jcarousel Image Path</label>
              <p><input name="jcarousel_path" maxlength="100" type="text" class="input-short" id="jcarousel_path" value="<?php echo $records['JCAROUSEL_IMAGES_FOLDER_PATH'];?>" /></p>
              <div class="cl"></div>
            </div>
            <div class="add-clip">
              <label>Themes Url Path </label>
              <p><input name="themes_path" maxlength="450" type="text" class="input-short" id="themes_path" value="<?php echo $records['THEMES_URLS'];?>" /></p>
              <div class="cl"></div>
            </div>
            <div class="add-clip">
