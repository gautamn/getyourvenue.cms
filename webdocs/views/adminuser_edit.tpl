   ...
   <div class="module-body">
      <form action="" id="adminuserForm" enctype="multipart/form-data" method="post">
         ...
         if(isset($msg)){?>
            ...
            <fieldset class="field_set">
              ...
              <p>
                ...
                <?php if(!empty($records['image'])){
                  $auserArtwork = getArtworkURL('auser',$records['image'],'small');
                }
          ...
          <div class="module-body-col2 <?php echo (($records['role_id']==2)?'':'hideSection'); ?>" id="adminUserInfo">
            <p>
            ...
            <p>
                ...
                <input name="alternate_mobile" type="text" class="input-medium" id="alternate_mobile" value="<?=$records['alternate_mobile']?>" />
            </p>
            ...
            <p>
              <label>Seo Key</label>
              <input type="text" class="input-medium" name="seo_key" id="seo_key" value="<?=$records['seo_key']?>" />
            </p>
          </div>
