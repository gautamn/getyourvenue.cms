        ...
        <form action="" id="alliedServiceForm" enctype="multipart/form-data" method="post">
          ...
          <div class="widthper fl">
            <div class="add-clip">
              ...
              <p><input name="service_name" maxlength="256" type="text" class="input-short" id="service_name" value="" /></p>
              <div class="cl"></div>
            </div>
            <div class="add-clip">
          ...
          <div class="widthper fr">
            ...
            <div class="add-clip">
              ...
              <p><input name="banner_path" maxlength="256" type="text" class="input-short" id="banner_path" value="" /></p>
              <div class="cl"></div>
            </div>
            <div class="add-clip">
              <label>Jcarousel Image Path <span class="star">*</span></label>
              <p><input name="jcarousel_path" maxlength="256" type="text" class="input-short" id="jcarousel_path" value="" /></p>
              <div class="cl"></div>
            </div>
            <div class="add-clip">
              <label>Themes Url Path </label>
              <p><input name="themes_path" maxlength="256" type="text" class="input-short" id="themes_path" value="" /></p>
              <div class="cl"></div>
            </div>
            <div class="add-clip">
