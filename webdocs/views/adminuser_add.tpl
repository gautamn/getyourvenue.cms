      ...
      <form action="" id="adminuserForm" enctype="multipart/form-data" method="post">
         ...
         if(isset($msg)){?>
          ...
          <div class="module-body-col1">
            <p>
                <label>Name</label>
                <input name="name" type="text" class="input-medium" id="name" value="" />
            </p>

            <p>
                <label>Username</label>
                <input name="username" type="text" class="input-medium" id="username" value="" onBlur="javascript:check_if_username_unique();"/>
            ...
            <p>
                <label>Email</label>
                <input name="email" type="text" class="input-medium" id="email" value="" />
            </p>

            <p>
                <label>Role</label>
                <?=get_dropdown ($arr_adminrole,'role_id',0,array("onChange"=>"showhideAdminUserInfo()"))?>
            </p>
            <p>
            ...
            <fieldset class="field_set">
              ...
              <p>
                ...
                <input type="hidden" name="auser_photo_hidden" id="auser_photo_hidden" value="" />
                <?php if(!empty($records['image'])){
          ...
          <div class="module-body-col2 hideSection" id="adminUserInfo">
            <p>
                ...
                <input name="designation" type="text" class="input-medium" id="designation" value="" />
            </p>

            <p>
                <label>Facebook URL</label>
                <input name="fb_url" type="text" class="input-medium" id="fb_url" value="" />
            </p>


            <p>
                <label>Twitter URL</label>
                <input name="twitter_url" type="text" class="input-medium" id="twitter_url" value="" />
            </p>

            <p>
                <label>Google Plus URL</label>
                <input name="google_plus_url" type="text" class="input-medium" id="google_plus_url" value="" />
            </p>

            <p>
                <label>Office Phone</label>
                <input name="office_phone" type="text" class="input-medium" id="office_phone" value="" />
            </p>


            <p>
                <label>Home Phone</label>
                <input name="home_phone" type="text" class="input-medium" id="home_phone" value="" />
            </p>

            <p>
                <label>Mobile</label>
                <input name="mobile" type="text" class="input-medium" id="mobile" value="" />
            </p>


            <p>
                <label>Alternate Mobile</label>
                <input name="alternate_mobile" type="text" class="input-medium" id="alternate_mobile" value="" />
            </p>

            <p>
            <fieldset>
                <label>About</label>
                <textarea name="about" id="about" rows="11" cols="42"></textarea>
            </fieldset>
            </p>
          </div>
